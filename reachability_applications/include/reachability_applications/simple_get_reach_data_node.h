...
/**
 * @class SimpleGetReachData
 **/
class SimpleGetReachData : public rclcpp::Node
{
 public:
 ...
 protected:
   ...
   void handleSrv(const std::shared_ptr<reachability_msgs::srv::GetReachData::Request> req,
                  std::shared_ptr<reachability_msgs::srv::GetReachData::Response> res);
 
   rclcpp::Service<reachability_msgs::srv::GetReachData>::SharedPtr srv_;
