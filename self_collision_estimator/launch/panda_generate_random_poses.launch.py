...
def generate_launch_description():
    ...
    robot_launch = IncludeLaunchDescription(
            PathJoinSubstitution([config_pkg, 'launch', 'panda/panda_config.launch.py'])
    )


    rc_dir = get_package_share_directory("robots_config")
    robot_description_config = xacro.process_file(os.path.join(rc_dir, "robots/panda/panda.urdf.xacro"), mappings ={'hand': 'true'})
